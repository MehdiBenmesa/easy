...
import dz.easy.androidclient.fragment.GroupeByModuleFragment;
import dz.easy.androidclient.fragment.ModuleDetailFragment;

/**
 * Created by Abderahmane on 10/04/2017.
 */
public class GroupeByModuleActivity extends AppCompatActivity implements Constants {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(i.hasExtra(GroupeByModuleFragment.ARG_ITEM_ID)){
            Fragment fragment =  GroupeByModuleFragment.newInstance(nomModul,moduleid,i.getStringExtra(GroupeByModuleFragment.ARG_ITEM_ID));
