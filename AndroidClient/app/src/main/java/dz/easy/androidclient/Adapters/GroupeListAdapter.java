...
public class GroupeListAdapter extends RecyclerView.Adapter<GroupeListAdapter.MyViewHolder> {
    ...
    Drawable btn;
    public GroupeListAdapter(JSONArray contents) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        try {
            ...
            final JSONObject seance = json.getJSONObject("sections");
            final JSONObject module = seance.getJSONObject("groupes");

            System.out.println("GROUPES : "+ module.getString("groupeName") +" =============== "+ module);
            ...
            holder.cardItem.setOnClickListener(new View.OnClickListener() {
               ...
               /*     Intent i = new Intent(view.getContext() , ModuleActivity.class);
                    ...
                    try {
                        ...
                        i.putExtra("namemodule",course.getString("name"));
