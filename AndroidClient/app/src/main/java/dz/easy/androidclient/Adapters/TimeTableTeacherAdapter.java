...
public class TimeTableTeacherAdapter extends RecyclerView.Adapter<TimeTableTeacherAdapter.MyViewHolder> {
    ...
    Drawable btn;
    public TimeTableTeacherAdapter(JSONObject contents) {
