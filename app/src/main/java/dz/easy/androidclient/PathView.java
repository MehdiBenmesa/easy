...
import dz.easy.androidclient.SvgUtils;
    ...
    private void getFromAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            if (a != null) {
                ...
                naturalColors = a.getBoolean(R.styleable.PathView_pathColor, false);
                fill = a.getBoolean(R.styleable.PathView_pathWidth,false);
                fillColor = a.getColor(R.styleable.PathView_pathColor,Color.argb(0,0,0,0));
            }
        } finally {
            if (a != null) {
                a.recycle();
